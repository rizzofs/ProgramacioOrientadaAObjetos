...
public class BibliotecaTest {
    public static void main(String[] args) {
        ...
        // Crear libros
        src.TP1.Ej6_biblioteca.Libro libro1 = new src.TP1.Ej6_biblioteca.Libro("El Libro de Aventuras", "Autor A", 300, new ListaEnlazada<>());
        src.TP1.Ej6_biblioteca.Libro libro2 = new src.TP1.Ej6_biblioteca.Libro("La Novela Romántica", "Autor B", 250, new ListaEnlazada<>());
